...
Thank you so much for your interest in contributing to create-linting!


## Asking questions, suggesting wonderful ideas or reporting bugs

You can [submit an issue️](https://github.com/Ionaru/create-linting/issues) on this GitHub repository.
...
```bash
git clone https://github.com/Ionaru/create-linting.git
cd create-linting
```
...
1. [Create a fork of this project](https://github.com/Ionaru/create-linting/fork).
2. Clone your fork: `git clone https://github.com/YOUR_USERNAME/create-linting.git`.
3. Add the original repository as remote to keep it up-to-date: `git remote add upstream https://github.com/Ionaru/create-linting.git`.
